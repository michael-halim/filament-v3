...
class EmployeeResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('User Name')->description('Put the user name details here')->schema([
                    ...
                    Forms\Components\Select::make('state_id')
                        ->options(fn (Get $get): Collections => State::query()
                    ...
                    Forms\Components\Select::make('city_id')
                        ->options(fn (Get $get): Collections => City::query()
                ...
                Tables\Actions\DeleteAction::make()
                    ->successNotification(
                        Notification::make()
                            ...
                            ->body('Your employee has been successfully deleted!')
                    ),
            ])
            ->bulkActions([
